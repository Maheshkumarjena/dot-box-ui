...
export default function Home() {
  ...
  const handleInviteFriend = () => {
    if (navigator.share) {
      navigator.share({
        title: 'Play Dots and Boxes with me!',
        url: window.location.href,
      }).then(() => console.log('Shared successfully.'))
        .catch((error) => console.log('Error sharing:', error));
    } else {
      alert('Web Share API is not supported on your browser. You can manually copy and share this link.');
    }
  };
      ...
      <div className="min-h-screen bg-gray-900 text-gray-100 py-8">
        <div className="max-w-md mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.div
            ...
            className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-gray-700 mb-8"
          >
            {error && (
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <Link href="/about#how-to-play" className="text-blue-400 hover:underline text-sm">
                  Game Rules
                </Link>
              </div>
                  </div>
          ...
          >
            <button
              ...
              className="px-4 py-2 bg-blue-600 hover:bg-blue-500 text-white rounded-md shadow-sm font-medium focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
            >
              Invite a Friend
            </button>
            <Link href="/about" className="px-4 py-2 bg-purple-600 hover:bg-purple-500 text-white rounded-md shadow-sm font-medium focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2">
